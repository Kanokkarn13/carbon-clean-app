...
export default function ProfileScreen() {
  ...
  const carbonKg =
    mode === "sum" ? carbonSumKg : mode === "walk" ? carbonWalkKg : carbonCycleKg;
        ...
        <View style={styles.progressSection}>
          ...
          <View style={styles.progressRow}>
            ...
            <View style={styles.progressTextWrap}>
              ...
              <Text style={styles.progressDesc}>
                You have saved {formatNum(carbonKg)} kg of carbon! That’s equivalent to {trees} trees planted.
              </Text>
            </View>
          </View>
          ...
          {showWalkRow && (
            <View style={styles.progressRow}>
              ...
              >
                <Ionicons name="walk-outline" size={20} color={theme.yellow} />
              </View>
              <View style={styles.progressTextWrap}>
          ...
          <View style={styles.progressRow}>
            ...
            <View style={styles.progressTextWrap}>
              ...
              <Text style={styles.progressDesc}>
                You have travelled {formatNum(distanceKm)} km — around {stadiumRounds} stadium rounds!
              </Text>
            </View>
          </View>
        </View>
